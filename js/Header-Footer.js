    ...
    <div class="products-holder">
      ...
      <i class="fa-solid fa-cart-shopping cart">
        ...
        <div class="main-cart">
          ...
          <a class="Check" href="">Check Out</a>
        </div>
      </i>
    </div>
...
<div class="nav-3">
  ...
  <ul class="nav-link">
    ...
    <li onclick="megaClick1()"> <div class="title">Pages <i class="fa-solid fa-angle-down"></i></div> 
    ...
    <li onclick="megaClick2()"><div class="title"> Shop <i class="fa-solid fa-angle-down"></i> </div>
    ...
    <li onclick="megaClick3()"><div class="title">Blog <i class="fa-solid fa-angle-down"></i> </div>
